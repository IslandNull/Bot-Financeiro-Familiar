...
if (!action) {
  console.error('Usage: node scripts/clasp-run.js <snapshot|summary|cut_first|safe_to_spend|copilot_digest_preview|closing_draft|closing_close|selftest|sheet_audit>');
  process.exit(1);
}
