...
if (!action) {
  console.error('Usage: node scripts/clasp-run.js <snapshot|summary|closing_draft|closing_close|ensure_remaining_mutation_config|ensure_april_2026_config|selftest>');
  process.exit(1);
}
