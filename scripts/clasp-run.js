...
if (!action) {
  console.error('Usage: node scripts/clasp-run.js <snapshot|summary|cut_first|safe_to_spend|copilot_digest_preview|copilot_digest_send|copilot_digest_trigger_setup|copilot_digest_trigger_remove|closing_draft|closing_close|selftest|sheet_audit>');
  process.exit(1);
}
