...
if (!action) {
  console.error('Usage: node scripts/clasp-run.js <snapshot|summary|closing_draft|closing_close|repair_premature_current_closing|repair_notebook_installment_pilot|reset_april_2026_clean_rebuild|ensure_remaining_mutation_config|ensure_april_2026_config|ensure_april_2026_house_debts|selftest>');
  process.exit(1);
}
