...
- Version @83 deployed on 2026-05-18 with audit, pilot, clean rebuild, and May launch hardening:
...
- Latest validation after @83: `npm run check`, `npm run snapshot`, `npm run summary`, and `npm run selftest` passed on 2026-05-18.
