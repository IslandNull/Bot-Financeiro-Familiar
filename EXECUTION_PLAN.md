...
- Version @82 deployed on 2026-05-17 with audit, pilot, clean rebuild, and May launch hardening:
  ...
  - deterministic overrides correct LLM category/source guesses for benefit conversion and own-source transfers.
- Latest validation after @82: `npm run check`, `npm run snapshot`, `npm run summary`, and `npm run selftest` passed on 2026-05-17.
