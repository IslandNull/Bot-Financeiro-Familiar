...
- Historical April production import verified: 1 Nubank card event, 25 reviewed Mercado Pago card events, 20 Mercado Pago yield events, and 7 reviewed PIX revenue/reimbursement events applied; repeated `--apply` returned duplicates only; snapshot and 2026-04 summary updated.
...
1. Continue April historical import from remaining reviewed rows only; next review transfers, obligations/faturas, and excluded/paired April rows.
