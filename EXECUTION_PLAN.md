...
- Version @95 deployed on 2026-05-18 with audit, pilot, clean rebuild, May launch hardening, `/resumo` exposure hardening, caixinha/cofrinho patrimonio updates, and Telegram UX hardening:
  ...
  - explicit `categoria <nome>` text overrides parser category guesses, and card purchase text can infer Mercado Pago/Nubank card when the parser omits the card.
...
- Latest validation after @95: `npm run check`, `npm run snapshot`, `npm run summary`, and `npm run selftest` passed on 2026-05-18.
